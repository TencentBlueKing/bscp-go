...
func FormatVersion() string {
	return fmt.Sprintf(`Client {"Version": "%s", "BuildTime": "%s", "GitHash": "%s"}`, VERSION, BUILDTIME, GITHASH)
}

// ShowServerVersion Server Version Should use api
func ShowServerVersion() {
	fmt.Println(formatServerVersion())
}

// ShowServerVersion Server Version Should use api
func formatServerVersion() string {
	return fmt.Sprintf(`Server {"Version": "%s", "BuildTime": "%s", "GitHash": "%s"}`, "", "", "")
}
